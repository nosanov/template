...
function initHeader() {
  ...
  if (header) {
    ...
    */
    var initStandardBehaviour = function initStandardBehaviour() {
    ...
    var behaviour = header.dataset.behaviour;
...
*/
function initPopup() {
  var srcButtons = document.querySelectorAll('[data-for="pop-up"]');
  ...
  if (srcButtons.length) {
    ...
    srcButtons.forEach(function (button) {
      button.addEventListener('click', function () {
        var targetHash = button.dataset.target;
        var popUp = document.getElementById(targetHash);
    ...
    popUps.forEach(function (popUp) {
      var closeBtn = popUp.querySelector('.pop-up__close');
